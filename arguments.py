...
def arguments():
    ...
    parser.add_argument('--learning_rate', '-lr', type=float, default=None,
                        help='Learning rate')
    parser.add_argument('--learning_rate_g', '-lr1', type=float, default=1e-4,   # def 2e-4
                        help='Learning rate for generator')
    parser.add_argument('--learning_rate_d', '-lr2', type=float, default=1e-4,
    ...
    parser.add_argument('--epoch', '-e', type=int, default=None,
                        help='epoch')
    parser.add_argument('--snapinterval', '-si', type=int, default=10, 
    ...
    parser.add_argument('--dis_sample', '-ds', default='down',          ## default down
    ...
    parser.add_argument('--gen_up', '-gu', default='unpool_res', choices=['unpool','unpool_res','deconv','none'],
    ...
    parser.add_argument('--warmup', type=int, default=200,
                        help='add loss L2(x,x_y) for warming-up iterations')
    ## loss function
    ...
    parser.add_argument('--lambda_air', '-la', type=float, default=0,   # 1e-4
    ...
    parser.add_argument('--lambda_tv', '-ltv', type=float, default=0,
                        help='lambda for the total variation')
    parser.add_argument('--lambda_wgan_gp', '-lwgp', type=float, default=10,  # default = 10.0
